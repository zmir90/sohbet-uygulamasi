// === SEVİYE 13.4 - DÜZELTİLMİŞ SERVER.JS (Çift 'upload' hatası giderildi) ===
...
(async () => {
    try {
        ...
        // user_sessions tablosu Neon'da manuel oluşturulduğu için burada kontrol etmeye gerek yok.
    } catch (err) {
...
const sessionMiddleware = session({
    store: new pgSession({ pool : pool, tableName : 'user_sessions' }), // Artık bu tablo var
...
// --- Multer Ayarları (Tek ve Doğru Tanım) ---
...
io.use((socket, next) => { /* ...içerik aynı... */ });
